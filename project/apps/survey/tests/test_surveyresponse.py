...
class SurveyResponseTest(TestCase):
    ...
    def test_making_a_new_response_creates_the_rating_objects(self):
        ...
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_1).health_state.number, survey_response.state_1.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_2).health_state.number, survey_response.state_2.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_3).health_state.number, survey_response.state_3.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_4).health_state.number, survey_response.state_4.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_5).health_state.number, survey_response.state_5.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_6).health_state.number, survey_response.state_6.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_7).health_state.number, survey_response.state_7.number)
        self.assertEquals(survey_path.ratings.get(health_state=survey_path.state_8).health_state.number, survey_response.state_8.number)
