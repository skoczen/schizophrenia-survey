...
SCREEN_DESCRIPTIONS_AND_URL_NAME = [
    ...
    {
        "id": "vas_training",
        "title": "Rating Scale Introduction",
        "reverse_url": "survey:vas_training",
        "reverse_args": None,
    },
    {
        "id": "tto_training",
        "title": "Timeline Tool Interoductio",
        "reverse_url": "survey:tto_training",
        "reverse_args": None,
    },
]
for i in range(1, 9):
    SCREEN_DESCRIPTIONS_AND_URL_NAME.extend([
        ...
        {
            "id": "hs%s_vas" % i,
            "title": "Health State %s - Rating Scale" % i,
