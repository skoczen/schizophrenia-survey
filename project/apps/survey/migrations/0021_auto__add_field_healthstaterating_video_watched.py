...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealthStateRating.video_watched'
        db.add_column(u'survey_healthstaterating', 'video_watched',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealthStateRating.video_watched'
        db.delete_column(u'survey_healthstaterating', 'video_watched')
