...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HealthStateSequenceUpload'
        db.create_table(u'survey_healthstatesequenceupload', (
        ...
        db.send_create_signal(u'survey', ['HealthStateSequenceUpload'])


    def backwards(self, orm):
        # Deleting model 'HealthStateSequenceUpload'
        db.delete_table(u'survey_healthstatesequenceupload')
