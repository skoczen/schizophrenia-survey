...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SurveyAggregateStats.dwell_time'
        db.alter_column(u'survey_surveyaggregatestats', 'dwell_time', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'SurveyAggregateStats.average_survey_progress'
        db.alter_column(u'survey_surveyaggregatestats', 'average_survey_progress', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'SurveyAggregateStats.completion_rate'
        db.alter_column(u'survey_surveyaggregatestats', 'completion_rate', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'SurveyAggregateStats.dwell_time'
        db.alter_column(u'survey_surveyaggregatestats', 'dwell_time', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SurveyAggregateStats.average_survey_progress'
        db.alter_column(u'survey_surveyaggregatestats', 'average_survey_progress', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SurveyAggregateStats.completion_rate'
        db.alter_column(u'survey_surveyaggregatestats', 'completion_rate', self.gf('django.db.models.fields.IntegerField')(null=True))
