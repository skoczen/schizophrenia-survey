...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SurveyExport'
        db.create_table(u'survey_surveyexport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('csv_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('num_rows', self.gf('django.db.models.fields.IntegerField')()),
            ('export_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'survey', ['SurveyExport'])


    def backwards(self, orm):
        # Deleting model 'SurveyExport'
        db.delete_table(u'survey_surveyexport')
