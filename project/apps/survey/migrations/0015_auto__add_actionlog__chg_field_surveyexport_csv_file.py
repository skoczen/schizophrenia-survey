...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_actionlog', (
        ...
        db.send_create_signal(u'survey', ['ActionLog'])


        # Changing field 'SurveyExport.csv_file'
        db.alter_column(u'survey_surveyexport', 'csv_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'ActionLog'
        db.delete_table(u'survey_actionlog')


        # User chose to not deal with backwards NULL issues for 'SurveyExport.csv_file'
        raise RuntimeError("Cannot reverse this migration. 'SurveyExport.csv_file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SurveyExport.csv_file'
        db.alter_column(u'survey_surveyexport', 'csv_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
