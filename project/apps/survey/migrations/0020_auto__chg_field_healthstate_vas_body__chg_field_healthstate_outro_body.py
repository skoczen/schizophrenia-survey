...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HealthState.vas_body'
        db.alter_column(u'survey_healthstate', 'vas_body', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))

        # Changing field 'HealthState.outro_body'
        db.alter_column(u'survey_healthstate', 'outro_body', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))

        # Changing field 'HealthState.intro_body'
        db.alter_column(u'survey_healthstate', 'intro_body', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))

        # Changing field 'HealthState.tto_body'
        db.alter_column(u'survey_healthstate', 'tto_body', self.gf('tinymce.models.HTMLField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'HealthState.vas_body'
        db.alter_column(u'survey_healthstate', 'vas_body', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Changing field 'HealthState.outro_body'
        db.alter_column(u'survey_healthstate', 'outro_body', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Changing field 'HealthState.intro_body'
        db.alter_column(u'survey_healthstate', 'intro_body', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Changing field 'HealthState.tto_body'
        db.alter_column(u'survey_healthstate', 'tto_body', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))
    ...
    models = {
        ...
        u'survey.healthstate': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intro_body': ('tinymce.models.HTMLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'outro_body': ('tinymce.models.HTMLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'severity_rating': ('django.db.models.fields.IntegerField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'tto_body': ('tinymce.models.HTMLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'vas_body': ('tinymce.models.HTMLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
