...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealthState.video_body'
        db.add_column(u'survey_healthstate', 'video_body',
                      self.gf('tinymce.models.HTMLField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealthState.video_body'
        db.delete_column(u'survey_healthstate', 'video_body')
