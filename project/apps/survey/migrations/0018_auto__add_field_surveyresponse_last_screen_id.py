...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyResponse.last_screen_id'
        db.add_column(u'survey_surveyresponse', 'last_screen_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyResponse.last_screen_id'
        db.delete_column(u'survey_surveyresponse', 'last_screen_id')
    ...
    models = {
        ...
        u'survey.surveyresponse': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_screen_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
