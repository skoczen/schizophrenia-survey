...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SurveyConfig'
        db.create_table(u'survey_surveyconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('top_anchor_label', self.gf('django.db.models.fields.CharField')(default='Perfect health', max_length=200)),
            ('bottom_anchor_label', self.gf('django.db.models.fields.CharField')(default='Worst imaginable health', max_length=200)),
        ))
        db.send_create_signal(u'survey', ['SurveyConfig'])


    def backwards(self, orm):
        # Deleting model 'SurveyConfig'
        db.delete_table(u'survey_surveyconfig')
    ...
    models = {
        ...
        u'survey.healthstate': {
            'Meta': {'ordering': "('number',)", 'object_name': 'HealthState'},
        ...
        u'survey.healthstaterating': {
            ...
            'video_watched': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        u'survey.surveyconfig': {
            'Meta': {'object_name': 'SurveyConfig'},
            'bottom_anchor_label': ('django.db.models.fields.CharField', [], {'default': "'Worst imaginable health'", 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'top_anchor_label': ('django.db.models.fields.CharField', [], {'default': "'Perfect health'", 'max_length': '200'})
        },
