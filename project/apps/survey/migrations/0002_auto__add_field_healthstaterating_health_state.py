...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealthStateRating.health_state'
        db.add_column(u'survey_healthstaterating', 'health_state',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['survey.HealthState']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealthStateRating.health_state'
        db.delete_column(u'survey_healthstaterating', 'health_state_id')
