...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyConfig.about_the_study_text'
        db.add_column(u'survey_surveyconfig', 'about_the_study_text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyConfig.about_the_study_text'
        db.delete_column(u'survey_surveyconfig', 'about_the_study_text')
    ...
    models = {
        ...
        u'survey.healthstate': {
            ...
            'video_body': ('tinymce.models.HTMLField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        u'survey.surveyconfig': {
            ...
            'about_the_study_text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
