...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SurveyAggregateStats'
        db.create_table(u'survey_surveyaggregatestats', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('completion_rate', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('average_survey_progress', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('dwell_time', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'survey', ['SurveyAggregateStats'])


    def backwards(self, orm):
        # Deleting model 'SurveyAggregateStats'
        db.delete_table(u'survey_surveyaggregatestats')
    ...
    models = {
        ...
        u'survey.surveyaggregatestats': {
            ...
            'average_survey_progress': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'completion_rate': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'dwell_time': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'survey.surveypath': {
