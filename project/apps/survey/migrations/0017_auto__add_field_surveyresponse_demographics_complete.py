...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyResponse.demographics_complete'
        db.add_column(u'survey_surveyresponse', 'demographics_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyResponse.demographics_complete'
        db.delete_column(u'survey_surveyresponse', 'demographics_complete')
