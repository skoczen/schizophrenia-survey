...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SurveyResponse.last_updated'
        db.add_column(u'survey_surveyresponse', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 11, 25, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SurveyResponse.last_updated'
        db.delete_column(u'survey_surveyresponse', 'last_updated')
