...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HealthStateRating.order'
        db.add_column(u'survey_healthstaterating', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HealthStateRating.order'
        db.delete_column(u'survey_healthstaterating', 'order')
